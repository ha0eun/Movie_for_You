...
def getRecommendation(cosin_sim):
    ...
    movie_idx = [i[0] for i in simScore]    # 영화의 인덱스 뽑았다
    recMovieList = df_reviews.iloc[movie_idx, 0]    # 영화 11개, 0 타이틀
    return recMovieList
...
## 영화 제목 이용
# movie_idx = df_reviews[df_reviews['titles']=='겨울왕국 2 (Frozen 2)'].index[0]     # 겨울왕국과 비슷한 영화를 추천
...
## 문장으로 추천
# sentence = '화려한 액션과 소름 돋는 반전이 있는 영화'    # 이 문장도 전처리 해야함
